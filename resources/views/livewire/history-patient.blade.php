            ...
            <div class="d-flex">
                ...
                <div style="width: 75%;margin-left: 5px;">
                    <div class="input-group">
                        ...
                        <select wire:model="subjetive_intensity" class="form-select" disabled>
                    ...
                    <div class="input-group">
                        ...
                        <select wire:model="rate" class="form-select" disabled>
                    ...
                    <div class="input-group">
                        ...
                        <select wire:model="consumption_painkillers" class="form-select" disabled>
                            <option value="null">Seleccione</option>
                            <option value="1">Nunca</option>
                    ...
                    <div class="input-group">
                        ...
                        <select wire:model="incapacitation" class="form-select" disabled>
                            <option value="null">Seleccione</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea wire:model="detail_diagnostic" class="form-control" rows="6" cols="" disabled></textarea>
                    </div>
                </div>
            </div>
